...
//        latitudeView = (TextView) findViewById(R.id.latitude);
        ...
        allyPings = myFirebaseRef.child("allyPings");
...
//                Toast.makeText(context, "Longitude toast: " + data.get("longitude").toString(), Toast.LENGTH_SHORT).show();
                    if (data != null) {
                        if (selfUser.getFullName() == null)
                            return;
                        Double longitude = (Double) data.get("longitude");
                        Double latitude = (Double) data.get("latitude");
                        String pingName = (String) data.get("name");
                        if (pingName == null)
                            return;


                        if (pingName.equals("michael") && !(selfUser.getFullName().equals("michael"))) {
                            isFriend(pingName, longitude, latitude, pingName);
                            return;
                        } else if (!(pingName.equals(selfUser.getFullName()))) {
                            Toast.makeText(context, selfUser.getFullName() + name, Toast.LENGTH_SHORT).show();
...
//
    ...
    void isPinger(){
        Intent pingedIntent = new Intent(this, PingedPage.class);
        startActivity(pingedIntent);
    }

    void isFriend(String name, Double longitude, Double latitude, String pingName) {
        //send friend intent
...
//            eraseFriend = true;
        ...
        Intent intent = new Intent(this, FriendPing.class);
        intent.putExtra("longitude", longitude);
        intent.putExtra("latitude", longitude);
        intent.putExtra("name", pingName);
        startActivity(intent);

        Toast.makeText(this, "We mathced with " + name, Toast.LENGTH_LONG).show();
...
//        //Toast.makeText(this, data.get("longitude"), Toast.LENGTH_LONG).show();
        ...
        if (dist< radius) {
            ...
            startActivity(intent);
            Toast.makeText(this, "Stranger pingedddd from: " + Double.toString(dist), Toast.LENGTH_SHORT).show();
        }
        else {
...
//        Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(this, "HIUpdated latitude: " + Double.toString(selfUser.getLatitude()), Toast.LENGTH_SHORT).show();
//        sentToStrangers();
    }
